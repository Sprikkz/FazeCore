...
class AxisAlignedBB{
    ...
    /**
     * Returns a new AxisAlignedBB expanded by the given X, Y, and Z.
     * If each of X, Y, and Z is positive, the corresponding maximum boundary will be increased.
     * If negative, the corresponding minimum boundary will be decreased.
     *
     * @param float $x
     * @param float $y
     * @param float $z
	...
	/**
     * Goes beyond the bounds of this AxisAlignedBB by the specified X, Y, and Z.
	 *
	 * @param float $x
	 * @param float $y
	 * @param float $z
	...
	/**
     * Offsets this AxisAlignedBB by the given X, Y and Z.
	 *
	 * @param float $x
	 * @param float $y
	 * @param float $z
	...
	/**
     * Sets the bounds of this AxisAlignedBB to the specified X, Y, and Z.
	 *
	 * @param float $x
	 * @param float $y
	 * @param float $z
	...
	/**
     * Returns a shortened clone of this AxisAlignedBB.
	 *
	 * @param float $x
	 * @param float $y
	 * @param float $z
	...
	/**
     * Returns whether any part of the specified AABB is inside (intersects) this one.
	 *
	 * @param AxisAlignedBB $bb
	 * @param float         $epsilon
	 *
	...
	/**
     * Returns whether the specified vector is within this AABB in all axes.
	 *
	...
	/**
     * Returns the average of the X, Y, and Z lengths of AABB.
	 * @return float
	 */
    ...
    /**
     * Performs a ray trace and calculates the point on the AABB edge closest to the starting position where the ray trace
     * collided. Returns a RayTraceResult with the collision vector closest to the starting position.
     * Returns null if no collision points were found.
     *
     * @param Vector3 $pos1
     * @param Vector3 $pos2
     *
