...
abstract class Terminal{
	...
	private static function detectFormattingCodesSupport() : bool{
		...
		$result = (
			...
			(
				getenv('TERM') !== false or //Консоль говорит, что поддерживает цвета
     ...
     * Please note that this is platform dependent and may produce different results depending on the terminal type and/or OS.
     *
    ...
    /**
     * Outputs a string containing Minecraft color codes to the console, formatted using custom colors.
     */
    ...
    /**
     * Prints a string to the console containing Minecraft color codes formatted with custom colors, followed by
     * newline character.
     */
