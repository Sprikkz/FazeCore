...
/**
 * A class used to process the Minecraft chat format and convert it into other formats, such as HTML.
 */
abstract class TextFormat{
	...
	/**
	 * Splits the string into format tokens.
	 *
	 * @param string $string
	 *
	 * @return array
	...
	/**
	 * Clears the string of Minecraft codes, ANSI escape codes, and invalid UTF-8 characters.
	 *
	 * @param string $string
	...
	/**
	 * Replaces placeholders § with the correct symbol. Only valid codes (as in the constants of the TextFormat class) will be converted.
	 *
	 * @param string $string
	...
	/**
	 * Returns the string in JSON format with colors/markup
	 *
	...
	public static function toJSON($string){
		...
		if($result === false){
			throw new \InvalidArgumentException("Failed to encode the JSON result: " . json_last_error_msg());
		}
		return $result;
	}

	/**
	 * Returns the string in HTML format with colors/markup
	 *
	 * @param string|array $string
	 *
	 * @return string
