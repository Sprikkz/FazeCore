...
use pocketmine\entity\animal\walking\{Chicken, Cow, Donkey, Llama, Mooshroom, Mule, Ocelot, Pig, Rabbit, Sheep, Villager};
use pocketmine\entity\animal\flying\{Bat, Parrot};
use pocketmine\entity\monster\flying\{Blaze, Ghast, Vex, Wither};
use pocketmine\entity\monster\jumping\{Slime, MagmaCube};
use pocketmine\entity\monster\walking\{WitherSkeleton, Evoker, CaveSpider, Creeper, Enderman, Husk, IronGolem, PigZombie, Silverfish, Skeleton, SnowGolem, Spider, Stray, Wolf, Zombie, ZombieVillager};
...
//		self::DATA_BOUNDING_BOX_HEIGHT => [self::DATA_TYPE_FLOAT, 1.8],
	...
	/** @var \pocketmine\timings\TimingsHandler */
	protected $timings;
