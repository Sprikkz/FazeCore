...
class PermissibleBase implements Permissible {
	...
	public function setOp($value){
		if($this->opable === null){
			throw new \LogicException("Cannot change op value because ServerOperator is not set");
		}else{
	...
	public function addAttachment(Plugin $plugin, $name = null, $value = null){
		if(!$plugin->isEnabled()){
			throw new PluginException("Plugin " . $plugin->getDescription()->getName() . " turned off");
		}
